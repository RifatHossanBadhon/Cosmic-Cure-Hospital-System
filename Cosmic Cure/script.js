document.addEventListener('DOMContentLoaded', () => {
    ...
    const loginEmail = document.getElementById('loginEmail'); // Corrected ID
    const loginPassword = document.getElementById('loginPassword'); // Corrected ID
