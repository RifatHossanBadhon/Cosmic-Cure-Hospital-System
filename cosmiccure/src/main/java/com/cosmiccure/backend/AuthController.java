...
public class AuthController {
    ...
    public ResponseEntity<?> registerUser(@RequestBody RegisterRequest registerRequest) {
        ...
        switch (registerRequest.getRole().toUpperCase()) {
            ...
            case "SUPPORT_STAFF":
                ...
                staff.setRole(registerRequest.getStaffRole().toUpperCase());
    ...
    public ResponseEntity<?> authenticateUser(@RequestBody LoginRequest loginRequest) {
        ...
        if (requestedProfileType.equals("PHARMACIST") && !actualUserRole.equals("PHARMACIST")) {
            return ResponseEntity.badRequest().body("Error: Invalid profile type for this user.");
        }
        if (requestedProfileType.equals("ADMIN") && !actualUserRole.equals("ADMIN")) {
            return ResponseEntity.badRequest().body("Error: Invalid profile type for this user.");
        }
        if (requestedProfileType.equals("SUPPORT_STAFF") && !actualUserRole.equals("SUPPORT_STAFF")) {
             return ResponseEntity.badRequest().body("Error: Invalid profile type for this user.");
        }
        if (!requestedProfileType.equals("PHARMACIST") && !requestedProfileType.equals("ADMIN") && !requestedProfileType.equals("SUPPORT_STAFF")) {
