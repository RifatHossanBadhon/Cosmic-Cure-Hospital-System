document.addEventListener('DOMContentLoaded', () => {
    ...
    if (chatbotIcon && chatbotContainer && closeChatbotBtn && chatbotInput && chatbotSendBtn && chatbotMessages) {
        ...
        // Show/hide chatbot icon based on current page
        ...
        showPage = (pageId) => {
            ...
            if (pageId === 'home') {
                ...
                chatbotContainer.classList.remove('active'); // Close chatbot if not on home page
            }
        };

        // Initial check for home page on load
